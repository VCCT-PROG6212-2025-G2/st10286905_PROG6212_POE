        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LecturerUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ModuleId = table.Column<int>(type: "int", nullable: false),
                    HoursWorked = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HourlyRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LecturerComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProgramCoordinatorUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ProgramCoordinatorAccepted = table.Column<bool>(type: "bit", nullable: true),
                    ProgramCoordinatorComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AcademicManagerUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AcademicManagerAccepted = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractClaims_AspNetUsers_AcademicManagerUserId",
                        column: x => x.AcademicManagerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ContractClaims_AspNetUsers_LecturerUserId",
                        column: x => x.LecturerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractClaims_AspNetUsers_ProgramCoordinatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LecturerModules_AspNetUsers_LecturerUserId",
                        column: x => x.LecturerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
